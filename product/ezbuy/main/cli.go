...
var client *ezbuy.HClient
var ez *ezbuy.EzbuyeApi
var isRefresh =false
func Start() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		client=&ezbuy.HClient{Token:token}
		...
		ez=&ezbuy.EzbuyeApi{Cookie:setting.Cookie,ReqId:setting.Reqid,ShopName:setting.StoreName,Client:client}
